      ...
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
          <div class="p-6 text-gray-900 dark:text-gray-100">
            <div>
              <h2 class="text-lg">Editar Docente Jubilado</h2>

              <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                Actualiza la información del docente jubilado.
              </p>
            </div>
<!--              <form @submit.prevent="form.put(route('docentes-jubilados.update', { id: docenteJubilado.id }), { onSuccess: () => form.reset() }) "-->
              <form
                      @submit.prevent="form.put(route('docentes-jubilados.update', { id: docenteJubilado.id }),  { onSuccess: () => form.reset() }) "
                  ...
                  <!--Numero de Celular-->
                  <div>
                      <InputLabel for="numero_celular" value="Número de Celular *"/>
                      ...
                      <TextInput
                              ...
                              required
                              autocomplete="numero_celular"
                      />

                      <InputError class="mt-2" :message="form.errors.numero_celular"/>
                  </div>
